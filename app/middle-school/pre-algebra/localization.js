...
const COPY = {
  ko: { breadcrumb: '대수 교육과정', title: '한국 중등·고등 · Pre-Algebra · Algebra 1·2 · Precalculus 문제 생성기', tags: ['수·식의 계산', '방정식·부등식', '일차·이차함수', '확률·통계', '복소수·다항식', '행렬·경우의 수', '지수·로그·수열'], controls: ['교육과정', '영역', '🇰🇷 한국 중학교 (중1 ~ 중3)', '🇰🇷 한국 고등학교 (2022 개정)', '🌐 국제학교 및 해외과정'], visual: ['열', '행', '합계', '줄기', '잎', '예', '계급', '도수', '이원분할표'] },
  en: { breadcrumb: 'Algebra curriculum', title: 'Pre-Algebra · Algebra 1–2 · Precalculus Worksheet Generator', tags: EN_TAGS, controls: ['Curriculum', 'Domain', '🇰🇷 Korea Middle School (Grades 7–9)', '🇰🇷 Korea High School (2022 Curriculum)', '🌐 International School Curricula'], visual: ['Column', 'Row', 'Total', 'Stem', 'Leaf', 'Example', 'Class interval', 'Frequency', 'Two-way table'] },
  'zh-CN': { breadcrumb: '代数课程', title: '预备代数 · 代数 1–2 练习生成器', tags: ['数与代数式', '方程与不等式', '一次与二次函数', '概率与统计', '复数与多项式', '矩阵与计数', '指数、对数与数列'], controls: ['课程', '领域', '🇰🇷 韩国初中课程 (初一 ~ 初三)', '🇰🇷 韩国高中课程 (2022 修订)', '🌐 国际学校课程'], visual: ['列', '行', '合计', '茎', '叶', '示例', '组距', '频数', '双向列联表'] },
  'zh-HK': { breadcrumb: '代數課程', title: '預備代數 · 代數 1–2 工作紙產生器', tags: ['數與代數式', '方程與不等式', '一次與二次函數', '概率與統計', '複數與多項式', '矩陣與計數', '指數、對數與數列'], controls: ['課程', '範疇', '🇰🇷 韓國初中課程 (中一 ~ 中三)', '🇰🇷 韓國高中課程 (2022 修訂)', '🌐 國際學校課程'], visual: ['欄', '列', '總計', '莖', '葉', '例子', '組別', '頻數', '雙向表'] },
  'zh-TW': { breadcrumb: '代數課程', title: '先備代數 · 代數 1–2 學習單產生器', tags: ['數與代數式', '方程式與不等式', '一次與二次函數', '機率與統計', '複數與多項式', '矩陣與計數', '指數、對數與數列'], controls: ['課程', '領域', '🇰🇷 韓國國中課程 (國一 ~ 國三)', '🇰🇷 韓國高中課程 (2022 課綱)', '🌐 國際學校課程'], visual: ['欄', '列', '總計', '莖', '葉', '例', '組距', '次數', '二維列聯表'] },
  ja: { breadcrumb: '代数カリキュラム', title: 'Pre-Algebra・Algebra 1–2 問題生成', tags: ['数と式の計算', '方程式と不等式', '一次・二次関数', '確率と統計', '複素数と多項式', '行列と場合の数', '指数・対数・数列'], controls: ['カリキュラム', '分野', '🇰🇷 韓国 中学校課程 (中1 ~ 中3)', '🇰🇷 韓国 高等学校課程 (2022改訂)', '🌐 インターナショナルスクール課程'], visual: ['列', '行', '合計', '幹', '葉', '例', '階級', '度数', '二元表'] },
  fr: { breadcrumb: 'Programme d’algèbre', title: 'Générateur Pré-algèbre · Algèbre 1–2', tags: ['Nombres et expressions', 'Équations et inéquations', 'Fonctions linéaires et quadratiques', 'Probabilités et statistiques', 'Complexes et polynômes', 'Matrices et dénombrement', 'Exponentielles, logarithmes et suites'], controls: ['Programme', 'Domaine', '🇰🇷 Corée · Collège (7e–9e)', '🇰🇷 Corée · Lycée (2022)', '🌐 Programmes internationaux'], visual: ['Colonne', 'Ligne', 'Total', 'Tige', 'Feuille', 'Exemple', 'Classe', 'Effectif', 'Tableau à double entrée'] },
  es: { breadcrumb: 'Currículo de álgebra', title: 'Generador de Preálgebra · Álgebra 1–2', tags: ['Números y expresiones', 'Ecuaciones e inecuaciones', 'Funciones lineales y cuadráticas', 'Probabilidad y estadística', 'Complejos y polinomios', 'Matrices y conteo', 'Exponentes, logaritmos y sucesiones'], controls: ['Currículo', 'Área', '🇰🇷 Corea · Secundaria (7.º–9.º)', '🇰🇷 Corea · Bachillerato (2022)', '🌐 Currículos internacionales'], visual: ['Columna', 'Fila', 'Total', 'Tallo', 'Hoja', 'Ejemplo', 'Intervalo', 'Frecuencia', 'Tabla de doble entrada'] },
  ru: { breadcrumb: 'Курс алгебры', title: 'Генератор: предалгебра · Алгебра 1–2', tags: ['Числа и выражения', 'Уравнения и неравенства', 'Линейные и квадратичные функции', 'Вероятность и статистика', 'Комплексные числа и многочлены', 'Матрицы и комбинаторика', 'Степени, логарифмы и последовательности'], controls: ['Программа', 'Раздел', '🇰🇷 Корея · Средняя школа (7–9 классы)', '🇰🇷 Корея · Старшая школа (2022)', '🌐 Международные программы'], visual: ['Столбец', 'Строка', 'Итого', 'Стебель', 'Лист', 'Пример', 'Интервал', 'Частота', 'Двумерная таблица'] },
  ar: { breadcrumb: 'منهج الجبر', title: 'مولّد ما قبل الجبر · الجبر 1–2', tags: ['الأعداد والعبارات', 'المعادلات والمتباينات', 'الدوال الخطية والتربيعية', 'الاحتمالات والإحصاء', 'الأعداد المركبة وكثيرات الحدود', 'المصفوفات والعدّ', 'الأسس واللوغاريتمات والمتتاليات'], controls: ['المنهج', 'المجال', '🇰🇷 كوريا · المرحلة المتوسطة (٧–٩)', '🇰🇷 كوريا · المرحلة الثانوية (٢٠٢٢)', '🌐 مناهج المدارس الدولية'], visual: ['عمود', 'صف', 'المجموع', 'الساق', 'الورقة', 'مثال', 'الفئة', 'التكرار', 'جدول ثنائي'] },
  pt: { breadcrumb: 'Currículo de álgebra', title: 'Gerador de Pré-Álgebra · Álgebra 1–2', tags: ['Números e expressões', 'Equações e inequações', 'Funções lineares e quadráticas', 'Probabilidade e estatística', 'Complexos e polinômios', 'Matrizes e contagem', 'Expoentes, logaritmos e sequências'], controls: ['Currículo', 'Área', '🇰🇷 Coreia · Ensino Fundamental II (7.º–9.º)', '🇰🇷 Coreia · Ensino Médio (2022)', '🌐 Currículos internacionais'], visual: ['Coluna', 'Linha', 'Total', 'Caule', 'Folha', 'Exemplo', 'Classe', 'Frequência', 'Tabela de dupla entrada'] },
  hi: { breadcrumb: 'बीजगणित पाठ्यक्रम', title: 'प्री-अल्जेब्रा · अल्जेब्रा 1–2 जनरेटर', tags: ['संख्याएँ और व्यंजक', 'समीकरण और असमिकाएँ', 'रैखिक और द्विघात फलन', 'प्रायिकता और सांख्यिकी', 'सम्मिश्र संख्याएँ और बहुपद', 'आव्यूह और गणना', 'घातांक, लघुगणक और अनुक्रम'], controls: ['पाठ्यक्रम', 'क्षेत्र', '🇰🇷 कोरिया · माध्यमिक विद्यालय (कक्षा 7–9)', '🇰🇷 कोरिया · उच्च विद्यालय (2022)', '🌐 अंतरराष्ट्रीय विद्यालय पाठ्यक्रम'], visual: ['स्तंभ', 'पंक्ति', 'कुल', 'तना', 'पत्ती', 'उदाहरण', 'वर्ग-अंतराल', 'बारंबारता', 'द्विमार्गी सारणी'] },
  vi: { breadcrumb: 'Chương trình đại số', title: 'Trình tạo Tiền đại số · Đại số 1–2', tags: ['Số và biểu thức', 'Phương trình và bất phương trình', 'Hàm bậc nhất và bậc hai', 'Xác suất và thống kê', 'Số phức và đa thức', 'Ma trận và phép đếm', 'Lũy thừa, logarit và dãy số'], controls: ['Chương trình', 'Lĩnh vực', '🇰🇷 Hàn Quốc · THCS (Lớp 7–9)', '🇰🇷 Hàn Quốc · THPT (2022)', '🌐 Chương trình trường quốc tế'], visual: ['Cột', 'Hàng', 'Tổng', 'Thân', 'Lá', 'Ví dụ', 'Khoảng lớp', 'Tần số', 'Bảng hai chiều'] },
  id: { breadcrumb: 'Kurikulum aljabar', title: 'Pembuat Pra-Aljabar · Aljabar 1–2', tags: ['Bilangan dan bentuk aljabar', 'Persamaan dan pertidaksamaan', 'Fungsi linear dan kuadrat', 'Peluang dan statistika', 'Bilangan kompleks dan polinom', 'Matriks dan pencacahan', 'Eksponen, logaritma, dan barisan'], controls: ['Kurikulum', 'Bidang', '🇰🇷 Korea · SMP (Kelas 7–9)', '🇰🇷 Korea · SMA (2022)', '🌐 Kurikulum sekolah internasional'], visual: ['Kolom', 'Baris', 'Total', 'Batang', 'Daun', 'Contoh', 'Interval kelas', 'Frekuensi', 'Tabel dua arah'] },
};
