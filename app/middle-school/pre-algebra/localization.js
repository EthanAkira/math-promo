...
const COPY = {
  ko: { breadcrumb: '대수 교육과정', title: '한국 중등·고등 · Pre-Algebra · Algebra 1·2 문제 생성기', tags: ['수·식의 계산', '방정식·부등식', '일차·이차함수', '확률·통계', '복소수·다항식', '행렬·경우의 수', '지수·로그·수열'], controls: ['교육과정', '영역', '한국 교육과정', '국제학교 과정'], visual: ['열', '행', '합계', '줄기', '잎', '예', '계급', '도수', '이원분할표'] },
  en: { breadcrumb: 'Algebra curriculum', title: 'Pre-Algebra · Algebra 1–2 Worksheet Generator', tags: EN_TAGS, controls: ['Curriculum', 'Domain', 'Korean curriculum', 'International-school curricula'], visual: ['Column', 'Row', 'Total', 'Stem', 'Leaf', 'Example', 'Class interval', 'Frequency', 'Two-way table'] },
