...
export const SECONDARY_ALGEBRA_UNITS = [
  ...
  { id: 'permutations-combinations', category: '경우의 수', label: '순열과 조합', description: '순서를 고려하는 배열과 선택', en: ['Permutations & combinations', 'Count ordered arrangements and selections'], profiles: profiles(P.H1, P.A2), make: permutationsCombinations },
  ...
  { id: 'exponential-equations', category: '지수와 로그', label: '지수함수와 지수방정식', description: '지수법칙과 같은 밑의 지수 비교', en: ['Exponential functions', 'Solve exponential equations and interpret growth'], profiles: profiles(P.A2), make: exponentialEquations },
  { id: 'logarithms', category: '지수와 로그', label: '로그', description: '로그의 정의와 기본 계산', en: ['Logarithms', 'Evaluate logarithms from their definition'], profiles: profiles(P.A2), make: logarithms },
  { id: 'sequences', category: '수열', label: '등차수열', description: '일반항과 첫 n항의 합', en: ['Arithmetic sequences', 'Find terms and finite sums'], profiles: profiles(P.A2), make: sequences },
