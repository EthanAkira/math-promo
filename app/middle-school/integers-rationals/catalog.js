...
export const RPM_RATIONAL_DECIMALS_APPLIED_UNITS = [
  ...
  { id: 'rpm-rat-dec-all-mixed', label: '[유리수와 순환소수 단원 종합] 유리수와 순환소수 전 유형 실전 혼합', description: '유리수와 순환소수 18개 핵심 유형 무작위 실전 출제 세트', en: ['Rational Decimals Comprehensive: All 18 Types Mixed', 'Randomized practice set covering all 18 rational numbers and repeating decimal types'], make: (random) => rpmRatDecAllTypesMixed(random) },
  { id: 'rpm-rat-dec-advanced-skill-up', label: '[유리수와 순환소수 실력 UP] 최고난도 심화 실전 문제', description: '연속 분수열 유한소수 조건, 자릿수 규칙 결합 및 고난도 심화', en: ['Rational Decimals Advanced: High-Level Skill UP', 'Challenging high-level problems on rational numbers, repeating decimals, and digit series'], make: (random) => rpmRatDecAdvancedSkillUp(random) },
];
