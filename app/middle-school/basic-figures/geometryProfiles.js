export const GEOMETRY_PROFILES = [
  {
    id: 'kr', locale: 'ko', label: '한국 중등 기하 (기본도형·작도·합동·닮음·원)', labelEn: 'Korea Middle School Geometry', shortLabel: '한국 중등',
  ...
  {
    id: 'csat', locale: 'ko', label: '한국 고등 · 수능 기하 (이차곡선·벡터·공간도형)', labelEn: 'Korea High School · CSAT Geometry', shortLabel: '수능 기하',
  ...
  {
    id: 'international', locale: 'en', label: 'International School (AP·IB·Cambridge)', labelEn: 'International School (AP·IB·Cambridge)', shortLabel: 'International',
  ...
  {
    id: 'amc', locale: 'en', label: 'AMC 8 (American Mathematics Competitions)', labelEn: 'AMC 8 (American Mathematics Competitions)', shortLabel: 'AMC 8',
  ...
  {
    id: 'amc12', locale: 'en', label: 'AMC 12 (Advanced Euclidean & Vector Geometry)', labelEn: 'AMC 12 (Advanced Euclidean & Vector Geometry)', shortLabel: 'AMC 12',
  ...
  {
    id: 'g12', locale: 'en', label: 'AP Precalculus & Calculus Geometry', labelEn: 'AP Precalculus & Calculus Geometry', shortLabel: 'AP',
  ...
  {
    id: 'ib', locale: 'en', label: 'IB Mathematics AA (Geometry & Trigonometry)', labelEn: 'IB Mathematics AA (Geometry & Trigonometry)', shortLabel: 'IB AA',
  ...
  {
    id: 'sg', locale: 'en-SG', label: 'Singapore Secondary Mathematics', labelEn: 'Singapore Secondary Mathematics', shortLabel: 'Singapore',
  ...
  {
    id: 'tw', locale: 'zh-TW', label: '臺灣 國中課程 (幾何·平行·空間)', labelEn: 'Taiwan Junior High Geometry', shortLabel: '臺灣',
  ...
  {
    id: 'hk', locale: 'zh-HK', label: '香港 初中課程 (幾何·平行·空間)', labelEn: 'Hong Kong Junior Secondary Geometry', shortLabel: '香港',
