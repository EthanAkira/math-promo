...
export const RPM_COORDINATE_APPLIED_UNITS = [
  { id: 'applied-coord-ordered-pair-equality', label: '[좌표평면 유형 01] 두 순서쌍이 서로 같을 조건', description: '두 순서쌍의 각 좌표가 같음을 이용하여 일차방정식 세워 미지수 구하기', en: ['Coordinate Plane Type 01: Equality of Ordered Pairs', 'Solve linear equations from equal ordered pairs'], make: rpmCoordOrderedPairEquality },
  { id: 'applied-coord-axis-points', label: '[좌표평면 유형 02] x축·y축 위의 점의 좌표와 미지수', description: 'x축 위의 점(y=0), y축 위의 점(x=0) 조건을 이용하여 미지수 좌표 구하기', en: ['Coordinate Plane Type 02: Points on Coordinate Axes', 'Use x-axis (y=0) and y-axis (x=0) conditions to solve for coordinates'], make: rpmCoordAxisPoints },
  { id: 'applied-coord-triangle-area', label: '[좌표평면 유형 03] 좌표평면 위 삼각형의 넓이', description: '좌표평면 위의 세 점을 꼭짓점으로 하는 삼각형의 넓이 구하기', en: ['Coordinate Plane Type 03: Triangle Area on Coordinate Plane', 'Calculate area of triangles from vertex coordinates'], make: rpmCoordTriangleArea },
  { id: 'applied-coord-polygon-area', label: '[좌표평면 유형 04] 좌표평면 위 사각형과 사다리꼴의 넓이', description: '좌표축에 평행한 선분을 이용하거나 직사각형에서 뺄셈하여 다각형 넓이 구하기', en: ['Coordinate Plane Type 04: Quadrilateral & Trapezoid Area', 'Calculate area of trapezoids and quadrilaterals by partitioning or enclosing rectangles'], make: rpmCoordPolygonArea },
  { id: 'applied-coord-quadrant-identify', label: '[좌표평면 유형 05] 사분면 판별과 좌표축 위의 점', description: '부호에 따른 제1, 2, 3, 4사분면 판별 및 좌표축 위의 점 식별', en: ['Coordinate Plane Type 05: Identifying Quadrants', 'Determine quadrants from signs and identify axis points'], make: rpmCoordQuadrantIdentify },
  { id: 'applied-coord-quadrant-sign-condition', label: '[좌표평면 유형 06] 사분면 조건과 변형된 점의 사분면', description: '점 (a, b)가 특정 사분면일 때 변형된 점 (-ab, a+b), (-b, -a) 등이 속하는 사분면 구하기', en: ['Coordinate Plane Type 06: Transformed Points Quadrant', 'Determine quadrant of transformed points given initial quadrant conditions'], make: rpmCoordQuadrantSignCondition },
  { id: 'applied-coord-sign-product-sum', label: '[좌표평면 유형 07] 곱과 합·차 부호 조건에 따른 사분면 판별', description: 'ab<0, a>b 또는 ab>0, a+b<0 등의 부호 조건에서 점의 사분면 구하기', en: ['Coordinate Plane Type 07: Quadrants from Product and Sum Signs', 'Find quadrant from sign constraints like ab<0, a>b, ab>0, a+b<0'], make: rpmCoordSignProductSum },
  { id: 'applied-coord-abs-condition-quadrant', label: '[좌표평면 유형 08] 절댓값 대소 조건과 사분면 판별 심화', description: 'ab<0, |a|<|b| 또는 |a|>|b| 조건에서 점 (a+b, a-b)의 부호와 사분면 구하기', en: ['Coordinate Plane Type 08: Quadrants with Absolute Value Inequalities', 'Analyze signs of sums and differences with absolute value comparisons'], make: rpmCoordAbsConditionQuadrant },
  { id: 'applied-coord-symmetric-points', label: '[좌표평면 유형 09] 대칭인 점의 좌표와 미지수 결정', description: 'x축 대칭, y축 대칭, 원점 대칭 조건을 이용하여 미지수 구하기', en: ['Coordinate Plane Type 09: Symmetric Points & Parameters', 'Solve coordinate equations using reflections across axes or the origin'], make: rpmCoordSymmetricPoints },
  { id: 'applied-coord-symmetric-area', label: '[좌표평면 유형 10] 대칭점들로 이루어진 도형의 넓이', description: '한 점과 그 점을 대칭이동한 점들로 이루어지는 직각삼각형의 넓이 계산하기', en: ['Coordinate Plane Type 10: Area from Symmetric Points', 'Compute areas of triangles formed by reflected points'], make: rpmCoordSymmetricArea },
  { id: 'applied-coord-graph-situation', label: '[좌표평면 유형 11] 상황에 알맞은 변화 그래프의 이해', description: '물 채우기, 향 타기, 일정한 속력 등 실생활 상황에 따른 그래프 개형 파악하기', en: ['Coordinate Plane Type 11: Graphing Real-world Situations', 'Match real scenarios with rate-of-change curves'], make: rpmCoordGraphSituation },
  { id: 'applied-coord-graph-distance-time', label: '[좌표평면 유형 12] 이동 거리-시간 그래프 정밀 분석', description: '거리-시간 그래프에서 도착 시각, 체류 시간, 반환점, 총 소요 시간 해석하기', en: ['Coordinate Plane Type 12: Distance-Time Graph Analysis', 'Extract arrival time, stay duration, turnaround point, and total trip time'], make: rpmCoordGraphDistanceTime },
  { id: 'applied-coord-graph-speed-time', label: '[좌표평면 유형 13] 속력-시간 그래프 및 운행 분석', description: '속력-시간 그래프에서 최고 속력, 정지 시간, 가속/감속 구간 분석하기', en: ['Coordinate Plane Type 13: Speed-Time Graph Analysis', 'Determine max speed, stopping duration, and acceleration phases from speed profiles'], make: rpmCoordGraphSpeedTime },
  { id: 'applied-coord-all-types-mixed', label: '[단원 실전 다지기] 매일 좌표평면과 그래프 종합', description: '순서쌍, 축 위의 점, 사분면, 부호 조건, 대칭, 넓이, 그래프 해석 전 유형 종합 출제', en: ['Daily Coordinate Plane Comprehensive', 'Comprehensive mixed practice covering all coordinate plane and graph types'], make: rpmCoordAllTypesMixed },
