...
export default function PrimeFactorizationGenerator() {
  ...
  return <div className="worksheet-app">
    <CurriculumMappingBar categoryKey="prime-factorization" language={language} />
    ...
    {view === 'problems' ? (
      <section className="grading-panel no-print">
        <div>
          ...
          <p>{foreign ? 'Use ^ for exponents, for example 2^3 × 5.' : '거듭제곱은 2^3 × 5처럼 입력하세요. 곱셈은 ×, x, * 모두 사용할 수 있습니다.'}</p>
        </div>
