...
const KOREAN_GRADE_STAGE_SEEDS = [
  ...
  // 중학교 1학년
  {
    ...
    availability: 'ready',
    topics: [
      { isHeader: true, label: '📘 [중1-1] 기본 문제 (교과서 핵심 개념)' },
      { label: '[기본] 소수와 소인수분해', href: '/middle-school/prime-factorization', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=primes-factorization&variant=1' } },
      { label: '[기본] 최대공약수와 최소공배수', href: '/middle-school/gcd-lcm', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=gcd-lcm&variant=1' } },
      { label: '[기본] 정수와 유리수의 개념과 대소', href: '/middle-school/integers-rationals', ready: true, availability: 'ready' },
      { label: '[기본] 문자의 사용과 식의 계산', href: '/middle-school/algebra-basics.html?unit=expressions-review', ready: true, availability: 'ready' },
      { label: '[기본] 일차방정식의 풀이', href: '/middle-school/algebra-basics.html?unit=equations-review', ready: true, availability: 'ready' },
      { label: '[기본] 좌표평면과 그래프', href: '/middle-school/coordinate-plane', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=coordinate-geometry&variant=1' } },
      { label: '[기본] 정비례와 반비례', href: '/middle-school/proportion', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=ratios-percent&variant=1' } },

      { isHeader: true, label: '📙 [중1-1] 유형별 실전 응용 (고난도 실전 다지기)' },
      { label: '[응용] 소인수분해 세부 유형 실전', href: '/middle-school/prime-factorization?unit=applied-prime-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 최대공약수와 최소공배수 세부 유형 실전', href: '/middle-school/gcd-lcm?unit=applied-gcd-lcm-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 정수와 유리수 세부 유형 실전', href: '/middle-school/integers-rationals?unit=applied-ir-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 문자의 사용과 식의 계산 세부 응용', href: '/middle-school/algebra-basics.html?unit=applied-algebra-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 좌표평면과 그래프 세부 응용', href: '/middle-school/coordinate-plane?unit=applied-coord-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 정비례와 반비례 세부 응용', href: '/middle-school/proportion?unit=applied-prop-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[실전 총괄] 중1-1 전 범위 종합 실전 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-1&unit=applied-grade7-semester-one-final-exam', ready: true, availability: 'ready' },

      { isHeader: true, label: '📘 [중1-2] 기본 문제 (교과서 핵심 개념)' },
      { label: '[기본] 기본 도형 (점·선·면·각)', href: '/middle-school/basic-figures?profile=kr&unit=visual-foundations', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=angles-plane-figures&variant=1' } },
      { label: '[기본] 다각형과 내각·외각', href: '/middle-school/basic-figures?profile=kr&unit=polygon-angles-basic', ready: true, availability: 'ready' },
      { label: '[기본] 원과 부채꼴', href: '/middle-school/basic-figures?profile=kr&unit=circle-sector-inverse-basic', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=circles&variant=1' } },
      { label: '[기본] 다면체·회전체와 전개도', href: '/middle-school/basic-figures?profile=kr&unit=polyhedron-concepts-euler', ready: true, availability: 'ready' },
      { label: '[기본] 입체도형의 겉넓이와 부피', href: '/middle-school/basic-figures?profile=kr&unit=expanded-solid-measures', ready: true, availability: 'ready' },
      { label: '[기본] 자료의 정리와 해석 (도수분포표)', href: '/middle-school/pre-algebra?profile=kr-middle-1&unit=frequency-table', ready: true, availability: 'ready' },

      { isHeader: true, label: '📙 [중1-2] 유형별 실전 응용 (고난도 실전 다지기)' },
      { label: '[응용] 기본 도형 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-geo-basic-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 위치 관계 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-pos-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 작도와 합동 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-cong-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 다각형 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-poly-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 원과 부채꼴 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-circle-sector-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 다면체와 회전체 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-polyhedra-revolution-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 입체도형 겉넓이·부피 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-solids-surface-volume-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 자료의 정리와 해석 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=applied-data-statistics-all-mixed', ready: true, availability: 'ready' },
      { label: '[실전 총괄] 중1-2 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/basic-figures?profile=kr&unit=applied-grade7-semester-two-final-exam', ready: true, availability: 'ready' },
    ],
  },
  ...
  // 중학교 2학년
  {
    ...
    availability: 'ready',
    topics: [
      { isHeader: true, label: '📘 [중2-1] 기본 문제 (교과서 핵심 개념)' },
      { label: '[기본] 유리수와 순환소수', href: '/middle-school/integers-rationals?unit=decimal-classification', ready: true, availability: 'ready' },
      { label: '[기본] 식의 계산 (지수법칙·단항식·다항식)', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=polynomial-operations-2', ready: true, availability: 'ready' },
      { label: '[기본] 일차부등식', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=linear-inequalities-2', ready: true, availability: 'ready' },
      { label: '[기본] 연립일차방정식', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=systems-linear', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=equations-inequalities&variant=1' } },
      { label: '[기본] 일차함수와 그래프', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=linear-functions-2', ready: true, availability: 'ready' },

      { isHeader: true, label: '📙 [중2-1] 유형별 실전 응용 (고난도 실전 다지기)' },
      { label: '[응용] 유리수와 순환소수 세부 응용', href: '/middle-school/integers-rationals?unit=applied-rat-dec-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 단항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-mono-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 다항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-poly-calc-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 일차부등식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-linear-ineq-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 일차부등식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-ineq-app-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 연립일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-sys-linear-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 연립일차방정식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-sys-app-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 일차함수와 그 그래프 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-linear-func-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 일차함수와 일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-line-eqn-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[실전 총괄] 중2-1 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-grade8-semester-one-final-exam', ready: true, availability: 'ready' },

      { isHeader: true, label: '📘 [중2-2] 기본 문제 (교과서 핵심 개념)' },
      { label: '[기본] 도형의 성질 (이등변삼각형·외심·내심)', href: '/middle-school/basic-figures?profile=kr&unit=isosceles-triangle-properties', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=quadrilaterals-polygons&variant=1' } },
      { label: '[기본] 사각형의 성질 (평행사변형·특별한 사각형)', href: '/middle-school/basic-figures?profile=kr&unit=special-quadrilaterals', ready: true, availability: 'ready' },
      { label: '[기본] 도형의 닮음과 평행선 사이 선분의 비', href: '/middle-school/basic-figures?profile=kr&unit=similarity-conditions', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=triangles&variant=1' } },
      { label: '[기본] 삼각형의 무게중심과 피타고라스 정리', href: '/middle-school/basic-figures?profile=kr&unit=pythagorean-basic', ready: true, availability: 'ready' },
      { label: '[기본] 경우의 수와 확률의 기본 성질', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=probability-2', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=probability&variant=1' } },

      { isHeader: true, label: '📙 [중2-2] 유형별 실전 응용 (고난도 실전 다지기)' },
      { label: '[응용] 중2 이등변삼각형 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-iso-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 삼각형의 외심과 내심 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-incenter-circumcenter-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 평행사변형 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-parallelogram-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 여러 가지 사각형 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-special-quads-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 도형의 닮음 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-similarity-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 평행선과 선분의 길이의 비 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-parallel-segments-all-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 삼각형의 무게중심 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-centroid-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 피타고라스 정리 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-pythagorean-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 경우의 수 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-cases-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[응용] 중2 확률과 그 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-prob-all-types-mixed', ready: true, availability: 'ready' },
      { label: '[실전 총괄] 중2-2 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-grade8-semester-two-final-exam', ready: true, availability: 'ready' },
    ],
  },
  ...
  // 중학교 3학년
  {
    ...
    availability: 'ready',
    topics: [
      { isHeader: true, label: '📘 [중3-1] 기본 문제 (교과서 핵심 개념)' },
      { label: '[기본] 제곱근과 실수', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=radicals-real-numbers&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 근호를 포함한 식의 계산', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-radical-ops-mult-div&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 다항식의 곱셈', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-poly-mult-square&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 인수분해', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=identities-factoring&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 이차방정식의 풀이', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=quadratic-equations&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 이차방정식의 활용', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-quad-app-numbers&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 이차함수와 그 그래프', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=quadratic-functions&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 이차함수 y = ax² + bx + c의 그래프', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-quad-func-standard-form&tier=basic', ready: true, availability: 'ready' },

      { isHeader: true, label: '📙 [중3-1] 유형별 실전 응용 (고난도 실전 다지기)' },
      { label: '[응용] 제곱근과 실수 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-radicals-real-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 근호를 포함한 식의 계산 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-radical-ops-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 다항식의 곱셈 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-poly-mult-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 인수분해 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-factorization-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 이차방정식의 풀이 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-quad-solve-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 이차방정식의 활용 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-quad-app-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 이차함수와 그 그래프 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-quad-func-graph-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 이차함수 y = ax² + bx + c 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-quad-func-std-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 중3-1 최고수준 심화 (실력 UP+)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-advanced-skill-up&tier=advanced', ready: true, availability: 'ready' },
      { label: '[실전 총괄] 중3-1 전 범위 종합 실전 모의고사 (25문항)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-grade9-semester-one-final-exam&tier=advanced', ready: true, availability: 'ready' },

      { isHeader: true, label: '📘 [중3-2] 기본 문제 (교과서 핵심 개념)' },
      { label: '[기본] 삼각비의 값과 특수각의 삼각비', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 삼각비의 활용 (변의 길이와 넓이)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 원의 성질 종합 (원과 직선 · 원주각)', href: '/middle-school/basic-figures?profile=kr&unit=circle-properties-mixed', ready: true, availability: 'ready' },
      { label: '[기본] 원과 직선 (현의 수직이등분선과 현의 길이)', href: '/middle-school/basic-figures?profile=kr&unit=circle-chord-properties', ready: true, availability: 'ready' },
      { label: '[기본] 원의 접선의 성질과 접선의 길이', href: '/middle-school/basic-figures?profile=kr&unit=circle-tangent-properties', ready: true, availability: 'ready' },
      { label: '[기본] 삼각형의 내접원과 외접사각형', href: '/middle-school/basic-figures?profile=kr&unit=circle-inscribed-circumscribed', ready: true, availability: 'ready' },
      { label: '[기본] 원주각과 중심각의 성질', href: '/middle-school/basic-figures?profile=kr&unit=circle-inscribed-angles', ready: true, availability: 'ready' },
      { label: '[기본] 원에 내접하는 사각형과 조건', href: '/middle-school/basic-figures?profile=kr&unit=circle-cyclic-quadrilaterals', ready: true, availability: 'ready' },
      { label: '[기본] 접선과 현이 이루는 각 (접현각)', href: '/middle-school/basic-figures?profile=kr&unit=circle-tangent-chord-angles', ready: true, availability: 'ready' },
      { label: '[기본] 대푯값과 산포도·상관관계', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=data-variation', ready: true, availability: 'ready' },

      { isHeader: true, label: '📙 [중3-2] 유형별 실전 응용 (고난도 실전 다지기)' },
      { label: '[응용] 삼각비의 값과 성질 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-ratios-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 삼각비의 활용(길이·넓이) 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-apps-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 원과 직선(현·접선) 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-circle-lines-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 원주각과 그 성질 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-inscribed-angles-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 대푯값과 산포도 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-stats-variation-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 상관관계와 산점도 분석 세부 유형 실전', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-scatter-correlation-all-mixed&tier=advanced', ready: true, availability: 'ready' },
      { label: '[응용] 중3-2 최고수준 심화 (실력 UP+)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-advanced-skill-up&tier=advanced', ready: true, availability: 'ready' },
      { label: '[실전 총괄] 중3-2 전 범위 종합 실전 모의고사 (25문항)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-grade9-semester-two-final-exam&tier=advanced', ready: true, availability: 'ready' },
    ],
  },
...
const INTERNATIONAL_COURSE_STAGE_SEEDS = [
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Linear Expressions & Equations', href: '/middle-school/algebra-basics.html?unit=equations-review', ready: true, availability: 'ready' },
      { label: 'Coordinate Plane & Graphs', href: '/middle-school/coordinate-plane', ready: true, availability: 'ready' },
      { label: 'Ratios & Proportions', href: '/middle-school/proportion', ready: true, availability: 'ready' },
      { label: 'Exponent Rules & Polynomial Operations', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=polynomial-operations-2', ready: true, availability: 'ready' },
      { label: 'Measures of Center & Spread', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=center-spread', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    availability: 'ready',
    topics: [
      { label: 'Real Numbers & Radicals', href: '/middle-school/pre-algebra?profile=algebra-1&unit=radicals-real-numbers', ready: true, availability: 'ready' },
      { label: 'Polynomial Multiplication & Factoring', href: '/middle-school/pre-algebra?profile=algebra-1&unit=identities-factoring', ready: true, availability: 'ready' },
      ...
      { label: 'Quadratic Equations & Solving Methods', href: '/middle-school/pre-algebra?profile=algebra-1&unit=quadratic-equations', ready: true, availability: 'ready' },
      ...
      { label: 'Bivariate Data & Scatter Plots', href: '/middle-school/pre-algebra?profile=algebra-1&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Right-Triangle Trigonometry (Sine, Cosine, Tangent)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: 'Trigonometric Applications (Heights & Areas)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
      ...
      { label: 'Circle Geometry (Chords, Tangents & Angles)', href: '/middle-school/basic-figures?profile=international&unit=circle-properties-mixed', ready: true, availability: 'ready' },
      { label: 'Solids: Surface Area & Volume', href: '/middle-school/basic-figures?profile=international&unit=expanded-solid-measures', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    availability: 'ready',
    topics: [
      { label: 'Math I · Linear Relationships & Equations', href: '/middle-school/algebra-basics.html?unit=equations-review', ready: true, availability: 'ready' },
      { label: 'Math I · Coordinate Geometry & Statistics', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=frequency-table', ready: true, availability: 'ready' },
      { label: 'Math II · Quadratics & Factoring', href: '/middle-school/pre-algebra?profile=algebra-1&unit=quadratic-equations', ready: true, availability: 'ready' },
      { label: 'Math II · Right-Triangle Trigonometry & Similarity', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: 'Math II · Circle Properties & Coordinate Proofs', href: '/middle-school/basic-figures?profile=international&unit=circle-properties-mixed', ready: true, availability: 'ready' },
      { label: 'Math III · Advanced Functions & Polynomials', href: '/middle-school/pre-algebra?profile=algebra-2&unit=polynomial-functions', ready: true, availability: 'ready' },
      { label: 'Math III · Trigonometric Functions & Modeling', href: '/middle-school/pre-algebra?profile=precalculus&unit=algebra2-trigonometry', ready: true, availability: 'ready' },
      { label: 'Math III · Statistics & Inferences', href: '/middle-school/pre-algebra?profile=algebra-2&unit=conditional-probability', ready: true, availability: 'ready' },
    ],
  },
];
 ...
 */
const ENGLISH_CORE_ELEMENTARY_TOPICS = [
  { label: 'Place Value to Millions', href: '/elementary/practice?grade=4&unit=g4e-m1a-place-value', ready: true, availability: 'ready' },
  { label: 'Rounding Large Numbers', href: '/elementary/practice?grade=4&unit=g4e-m1c-rounding', ready: true, availability: 'ready' },
  { label: 'Multi-Digit Addition (Standard Algorithm)', href: '/elementary/practice?grade=4&unit=g4e-m1d-addition', ready: true, availability: 'ready' },
  { label: 'Multi-Digit Subtraction (Standard Algorithm)', href: '/elementary/practice?grade=4&unit=g4e-m1e-subtraction', ready: true, availability: 'ready' },
  { label: 'Metric Unit Conversion', href: '/elementary/practice?grade=4&unit=g4e-m2a-metric-convert', ready: true, availability: 'ready' },
  { label: 'Area, Perimeter & Multiplicative Comparison', href: '/elementary/practice?grade=4&unit=g4e-m3a-area-perimeter-compare', ready: true, availability: 'ready' },
  { label: 'Multi-Digit × 1-Digit Multiplication', href: '/elementary/practice?grade=4&unit=g4e-m3c-multiply-multidigit-1digit', ready: true, availability: 'ready' },
  { label: 'Division with Remainders', href: '/elementary/practice?grade=4&unit=g4e-m3e-division-remainders', ready: true, availability: 'ready' },
  { label: 'Factors, Multiples & Prime Numbers', href: '/elementary/practice?grade=4&unit=g4e-m3f-factors-primes', ready: true, availability: 'ready' },
  { label: '2-Digit × 2-Digit Multiplication', href: '/elementary/practice?grade=4&unit=g4e-m3h-multiply-2x2', ready: true, availability: 'ready' },
  { label: 'Lines, Angles & Classification', href: '/elementary/practice?grade=4&unit=g4e-m4a-lines-angles', ready: true, availability: 'ready' },
  { label: 'Measuring Angles with a Protractor', href: '/elementary/practice?grade=4&unit=g4e-m4b-angle-measure', ready: true, availability: 'ready' },
  { label: 'Classifying Triangles & Quadrilaterals', href: '/elementary/practice?grade=4&unit=g4e-m4d-figures-symmetry', ready: true, availability: 'ready' },
  { label: 'Equivalent Fractions', href: '/elementary/practice?grade=4&unit=g4e-m5b-fraction-equivalence', ready: true, availability: 'ready' },
  { label: 'Adding & Subtracting Fractions', href: '/elementary/practice?grade=4&unit=g4e-m5d-fraction-add-sub-like', ready: true, availability: 'ready' },
  { label: 'Mixed Numbers: Addition & Subtraction', href: '/elementary/practice?grade=4&unit=g4e-m5f-mixed-number-add-sub', ready: true, availability: 'ready' },
  { label: 'Decimals: Tenths & Hundredths', href: '/elementary/practice?grade=4&unit=g4e-m6b-hundredths', ready: true, availability: 'ready' },
  { label: 'Adding & Subtracting Decimals', href: '/elementary/practice?grade=4&unit=g4e-m6d-decimal-addition', ready: true, availability: 'ready' },
  { label: 'Measurement Conversion Tables', href: '/elementary/practice?grade=4&unit=g4e-m7a-conversion-tables', ready: true, availability: 'ready' },
  { label: 'Composite Figure Area', href: '/elementary/practice?grade=4&unit=g4e-m7d-composite-area-review', ready: true, availability: 'ready' },
];
...
const JAPAN_STAGE_SEEDS = [
  {
    id: 'jp-shogakko-4',
    title: '小学校算数 (4年生)',
    subtitle: 'Primary Mathematics · Grade 4 · Eureka Math / EngageNY 構成',
    availability: 'ready',
    topics: [
      { label: '大きい数の位取り (百万まで)', href: '/elementary/practice?grade=4&unit=g4e-m1a-place-value', ready: true, availability: 'ready' },
      { label: '大きい数の四捨五入', href: '/elementary/practice?grade=4&unit=g4e-m1c-rounding', ready: true, availability: 'ready' },
      { label: '大きい数のたし算 (筆算)', href: '/elementary/practice?grade=4&unit=g4e-m1d-addition', ready: true, availability: 'ready' },
      { label: '大きい数のひき算 (筆算)', href: '/elementary/practice?grade=4&unit=g4e-m1e-subtraction', ready: true, availability: 'ready' },
      { label: 'メートル法の単位換算', href: '/elementary/practice?grade=4&unit=g4e-m2a-metric-convert', ready: true, availability: 'ready' },
      { label: '面積・周の長さと何倍の文章題', href: '/elementary/practice?grade=4&unit=g4e-m3a-area-perimeter-compare', ready: true, availability: 'ready' },
      { label: '何桁×1桁のかけ算', href: '/elementary/practice?grade=4&unit=g4e-m3c-multiply-multidigit-1digit', ready: true, availability: 'ready' },
      { label: 'あまりのあるわり算', href: '/elementary/practice?grade=4&unit=g4e-m3e-division-remainders', ready: true, availability: 'ready' },
      { label: '約数・倍数と素数', href: '/elementary/practice?grade=4&unit=g4e-m3f-factors-primes', ready: true, availability: 'ready' },
      { label: '2桁×2桁のかけ算', href: '/elementary/practice?grade=4&unit=g4e-m3h-multiply-2x2', ready: true, availability: 'ready' },
      { label: '直線と角の基礎 (垂直・平行)', href: '/elementary/practice?grade=4&unit=g4e-m4a-lines-angles', ready: true, availability: 'ready' },
      { label: '分度器を使った角の測定', href: '/elementary/practice?grade=4&unit=g4e-m4b-angle-measure', ready: true, availability: 'ready' },
      { label: '三角形・四角形の分類', href: '/elementary/practice?grade=4&unit=g4e-m4d-figures-symmetry', ready: true, availability: 'ready' },
      { label: '等しい分数(同値分数)', href: '/elementary/practice?grade=4&unit=g4e-m5b-fraction-equivalence', ready: true, availability: 'ready' },
      { label: '分数のたし算とひき算', href: '/elementary/practice?grade=4&unit=g4e-m5d-fraction-add-sub-like', ready: true, availability: 'ready' },
      { label: '帯分数のたし算とひき算', href: '/elementary/practice?grade=4&unit=g4e-m5f-mixed-number-add-sub', ready: true, availability: 'ready' },
      { label: '小数:10分の1と100分の1', href: '/elementary/practice?grade=4&unit=g4e-m6b-hundredths', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: '因数分解と乗法公式', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=identities-factoring&tier=basic', ready: true, availability: 'ready' },
      ...
      { label: '円周角の定理と接線の性質', href: '/middle-school/basic-figures?profile=kr&unit=circle-inscribed-angles', ready: true, availability: 'ready' },
      { label: '三平方の定理', href: '/middle-school/basic-figures?unit=pythagorean-applications', ready: true, availability: 'ready' },
      { label: '三角比の基礎 (直角三角形と特別な角)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: '三角比の応用 (測量と面積)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
      { label: '散布図と相関関係', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
...
const TAIWAN_STAGE_SEEDS = [
  {
    id: 'tw-elementary',
    title: '國小數學 (四年級)',
    subtitle: 'Primary Mathematics · Grade 4 · Eureka Math / EngageNY 架構',
    availability: 'ready',
    topics: [
      { label: '大數的位值 (到百萬位)', href: '/elementary/practice?grade=4&unit=g4e-m1a-place-value', ready: true, availability: 'ready' },
      { label: '大數的四捨五入', href: '/elementary/practice?grade=4&unit=g4e-m1c-rounding', ready: true, availability: 'ready' },
      { label: '大數的直式加法', href: '/elementary/practice?grade=4&unit=g4e-m1d-addition', ready: true, availability: 'ready' },
      { label: '大數的直式減法', href: '/elementary/practice?grade=4&unit=g4e-m1e-subtraction', ready: true, availability: 'ready' },
      { label: '公制單位換算', href: '/elementary/practice?grade=4&unit=g4e-m2a-metric-convert', ready: true, availability: 'ready' },
      { label: '面積、周長與倍數應用題', href: '/elementary/practice?grade=4&unit=g4e-m3a-area-perimeter-compare', ready: true, availability: 'ready' },
      { label: '多位數乘以一位數', href: '/elementary/practice?grade=4&unit=g4e-m3c-multiply-multidigit-1digit', ready: true, availability: 'ready' },
      { label: '有餘數的除法', href: '/elementary/practice?grade=4&unit=g4e-m3e-division-remainders', ready: true, availability: 'ready' },
      { label: '因數、倍數與質數', href: '/elementary/practice?grade=4&unit=g4e-m3f-factors-primes', ready: true, availability: 'ready' },
      { label: '兩位數乘以兩位數', href: '/elementary/practice?grade=4&unit=g4e-m3h-multiply-2x2', ready: true, availability: 'ready' },
      { label: '直線與角的基礎(垂直與平行)', href: '/elementary/practice?grade=4&unit=g4e-m4a-lines-angles', ready: true, availability: 'ready' },
      { label: '用量角器測量角度', href: '/elementary/practice?grade=4&unit=g4e-m4b-angle-measure', ready: true, availability: 'ready' },
      { label: '三角形與四邊形的分類', href: '/elementary/practice?grade=4&unit=g4e-m4d-figures-symmetry', ready: true, availability: 'ready' },
      { label: '等值分數', href: '/elementary/practice?grade=4&unit=g4e-m5b-fraction-equivalence', ready: true, availability: 'ready' },
      { label: '分數的加法與減法', href: '/elementary/practice?grade=4&unit=g4e-m5d-fraction-add-sub-like', ready: true, availability: 'ready' },
      { label: '帶分數的加法與減法', href: '/elementary/practice?grade=4&unit=g4e-m5f-mixed-number-add-sub', ready: true, availability: 'ready' },
      { label: '小數:十分位與百分位', href: '/elementary/practice?grade=4&unit=g4e-m6b-hundredths', ready: true, availability: 'ready' },
      { label: '小數的加法與減法', href: '/elementary/practice?grade=4&unit=g4e-m6d-decimal-addition', ready: true, availability: 'ready' },
      { label: '換算表的應用', href: '/elementary/practice?grade=4&unit=g4e-m7a-conversion-tables', ready: true, availability: 'ready' },
      { label: '複合圖形的面積', href: '/elementary/practice?grade=4&unit=g4e-m7d-composite-area-review', ready: true, availability: 'ready' },
    ],
  },
  {
    id: 'tw-junior',
    ...
    topics: [
      ...
      { label: '乘法公式與因式分解', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=identities-factoring&tier=basic', ready: true, availability: 'ready' },
      ...
      { label: '圓周角與圓內接四邊形', href: '/middle-school/basic-figures?profile=tw&unit=circle-inscribed-angles', ready: true, availability: 'ready' },
      { label: '銳角三角比與特殊角', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: '三角比的應用 (邊長與面積)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
      { label: '機率', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=probability-2', ready: true, availability: 'ready' },
      { label: '散佈圖與相關性', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
...
const HONGKONG_STAGE_SEEDS = [
  {
    id: 'hk-elementary',
    title: 'Primary Mathematics (Primary 4)',
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Polynomial Identities & Factorization', href: '/middle-school/pre-algebra?profile=algebra-1&unit=identities-factoring', ready: true, availability: 'ready' },
      ...
      { label: 'Circle Theorems & Inscribed Angles', href: '/middle-school/basic-figures?profile=hk&unit=circle-properties-mixed', ready: true, availability: 'ready' },
      { label: 'Trigonometric Ratios & Special Angles', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: 'Applications of Trigonometry (Lengths & Areas)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
      { label: 'Probability', href: '/middle-school/pre-algebra?profile=algebra-1&unit=probability-2', ready: true, availability: 'ready' },
      { label: 'Bivariate Data & Scatter Diagrams', href: '/middle-school/pre-algebra?profile=algebra-1&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
...
const SINGAPORE_STAGE_SEEDS = [
  {
    id: 'sg-elementary',
    title: 'Primary Mathematics (Primary 4)',
    subtitle: 'MOE Syllabus · Eureka Math / EngageNY structure',
    availability: 'ready',
    topics: ENGLISH_CORE_ELEMENTARY_TOPICS,
  },
  {
    ...
    topics: [
      ...
      { label: 'Simultaneous Linear Equations', href: '/middle-school/pre-algebra?profile=algebra-1&unit=systems-linear', ready: true, availability: 'ready' },
      { label: 'Coordinate Plane & Linear Graphs', href: '/middle-school/coordinate-plane', ready: true, availability: 'ready' },
      ...
      { label: 'Polygons: Interior & Exterior Angles', href: '/middle-school/basic-figures?profile=sg&unit=polygon-angles-basic', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    availability: 'ready',
    topics: [
      { label: 'Expansion & Factorisation of Algebraic Expressions', href: '/middle-school/pre-algebra?profile=algebra-1&unit=identities-factoring', ready: true, availability: 'ready' },
      { label: 'Quadratic Equations', href: '/middle-school/pre-algebra?profile=algebra-1&unit=quadratic-equations', ready: true, availability: 'ready' },
      { label: 'Quadratic Functions & Graphs', href: '/middle-school/pre-algebra?profile=algebra-1&unit=quadratic-functions', ready: true, availability: 'ready' },
      ...
      { label: 'Trigonometric Ratios & Right-Triangle Applications', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      ...
      { label: 'Angles in Circles (Inscribed Angles & Tangent Theorems)', href: '/middle-school/basic-figures?profile=sg&unit=circle-inscribed-angles', ready: true, availability: 'ready' },
...
const MALAYSIA_STAGE_SEEDS = [
  {
    id: 'my-elementary',
    title: 'Primary Mathematics (Tahun 4)',
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Factorisation & Algebraic Fractions', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=identities-factoring', ready: true, availability: 'ready' },
      ...
      { label: "Pythagoras' Theorem", href: '/middle-school/basic-figures?profile=kr&unit=pythagorean-basic', ready: true, availability: 'ready' },
      { label: 'Trigonometric Ratios (Sin, Cos, Tan)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      ...
      { label: 'Angles in Circles & Cyclic Quadrilaterals', href: '/middle-school/basic-figures?profile=kr&unit=circle-inscribed-angles', ready: true, availability: 'ready' },
      ...
      { label: 'Scatter Plots & Correlation', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
...
const VIETNAM_STAGE_SEEDS = [
  {
    id: 'vn-tieuhoc',
    title: 'Toán Lớp 4',
    subtitle: 'Chương trình GDPT 2018 · Tiểu học · Cấu trúc Eureka Math / EngageNY',
    availability: 'ready',
    topics: [
      { label: 'Giá trị theo hàng của số lớn (đến hàng triệu)', href: '/elementary/practice?grade=4&unit=g4e-m1a-place-value', ready: true, availability: 'ready' },
      { label: 'Làm tròn số lớn', href: '/elementary/practice?grade=4&unit=g4e-m1c-rounding', ready: true, availability: 'ready' },
      { label: 'Phép cộng số nhiều chữ số (đặt tính)', href: '/elementary/practice?grade=4&unit=g4e-m1d-addition', ready: true, availability: 'ready' },
      { label: 'Phép trừ số nhiều chữ số (đặt tính)', href: '/elementary/practice?grade=4&unit=g4e-m1e-subtraction', ready: true, availability: 'ready' },
      { label: 'Đổi đơn vị đo lường hệ mét', href: '/elementary/practice?grade=4&unit=g4e-m2a-metric-convert', ready: true, availability: 'ready' },
      { label: 'Diện tích, chu vi và bài toán so sánh gấp bội', href: '/elementary/practice?grade=4&unit=g4e-m3a-area-perimeter-compare', ready: true, availability: 'ready' },
      { label: 'Nhân số nhiều chữ số với số có 1 chữ số', href: '/elementary/practice?grade=4&unit=g4e-m3c-multiply-multidigit-1digit', ready: true, availability: 'ready' },
      { label: 'Phép chia có dư', href: '/elementary/practice?grade=4&unit=g4e-m3e-division-remainders', ready: true, availability: 'ready' },
      { label: 'Ước số, bội số và số nguyên tố', href: '/elementary/practice?grade=4&unit=g4e-m3f-factors-primes', ready: true, availability: 'ready' },
      { label: 'Nhân số có 2 chữ số với số có 2 chữ số', href: '/elementary/practice?grade=4&unit=g4e-m3h-multiply-2x2', ready: true, availability: 'ready' },
      { label: 'Đường thẳng và góc (vuông góc, song song)', href: '/elementary/practice?grade=4&unit=g4e-m4a-lines-angles', ready: true, availability: 'ready' },
      { label: 'Đo góc bằng thước đo góc', href: '/elementary/practice?grade=4&unit=g4e-m4b-angle-measure', ready: true, availability: 'ready' },
      { label: 'Phân loại tam giác và tứ giác', href: '/elementary/practice?grade=4&unit=g4e-m4d-figures-symmetry', ready: true, availability: 'ready' },
      { label: 'Phân số bằng nhau', href: '/elementary/practice?grade=4&unit=g4e-m5b-fraction-equivalence', ready: true, availability: 'ready' },
      { label: 'Cộng và trừ phân số', href: '/elementary/practice?grade=4&unit=g4e-m5d-fraction-add-sub-like', ready: true, availability: 'ready' },
      { label: 'Cộng và trừ hỗn số', href: '/elementary/practice?grade=4&unit=g4e-m5f-mixed-number-add-sub', ready: true, availability: 'ready' },
      { label: 'Số thập phân: hàng phần mười và phần trăm', href: '/elementary/practice?grade=4&unit=g4e-m6b-hundredths', ready: true, availability: 'ready' },
      { label: 'Cộng và trừ số thập phân', href: '/elementary/practice?grade=4&unit=g4e-m6d-decimal-addition', ready: true, availability: 'ready' },
      { label: 'Bảng quy đổi đơn vị đo', href: '/elementary/practice?grade=4&unit=g4e-m7a-conversion-tables', ready: true, availability: 'ready' },
      { label: 'Diện tích hình ghép', href: '/elementary/practice?grade=4&unit=g4e-m7d-composite-area-review', ready: true, availability: 'ready' },
    ],
  },
  {
    id: 'vn-thcs',
    ...
    topics: [
      ...
      { label: 'Hằng đẳng thức và phân tích đa thức thành nhân tử', href: '/middle-school/pre-algebra?profile=algebra-1&unit=identities-factoring', ready: true, availability: 'ready' },
      ...
      { label: 'Tỉ số lượng giác của góc nhọn (Sin, Cos, Tan)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: 'Ứng dụng tỉ số lượng giác (độ dài và diện tích)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
      ...
      { label: 'Góc nội tiếp và góc tạo bởi tiếp tuyến và dây cung', href: '/middle-school/basic-figures?profile=kr&unit=circle-inscribed-angles', ready: true, availability: 'ready' },
      { label: 'Thống kê', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=center-spread', ready: true, availability: 'ready' },
      { label: 'Biểu đồ phân tán và tương quan số liệu', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
...
const INDIA_STAGE_SEEDS = [
  {
    id: 'in-elementary',
    title: 'Primary Mathematics (Class 4)',
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Trigonometric Ratios & Values of Special Angles', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: 'Some Applications of Trigonometry (Heights & Distances)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
      ...
      { label: 'Circles: Inscribed Angles & Cyclic Quadrilaterals', href: '/middle-school/basic-figures?profile=kr&unit=circle-inscribed-angles', ready: true, availability: 'ready' },
      ...
      { label: 'Statistics', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=center-spread', ready: true, availability: 'ready' },
      { label: 'Bivariate Data & Scatter Plots', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
      { label: 'Probability', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=probability-2', ready: true, availability: 'ready' },
    ],
  },
  {
...
const ENGLISH_CORE_MIDDLE_TOPICS = [
  ...
  { label: 'Radicals, Exponents & Polynomial Factoring', href: '/middle-school/pre-algebra?profile=algebra-1&unit=identities-factoring', ready: true, availability: 'ready' },
  { label: 'Quadratic Equations & Solving Methods', href: '/middle-school/pre-algebra?profile=algebra-1&unit=quadratic-equations', ready: true, availability: 'ready' },
  ...
  { label: 'Right-Triangle Trigonometry & Special Angles', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
  { label: 'Trigonometric Applications (Heights & Areas)', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
  { label: 'Circle Geometry (Chords, Tangents & Inscribed Angles)', href: '/middle-school/basic-figures?profile=international&unit=circle-properties-mixed', ready: true, availability: 'ready' },
  ...
  { label: 'Bivariate Data, Scatter Plots & Correlation', href: '/middle-school/pre-algebra?profile=pre-algebra&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
];
...
const DOMAIN_STAGE_SEEDS = [
  {
    ...
    topics: [
      ...
      { label: '[기본] 유리수와 순환소수', href: '/middle-school/integers-rationals?unit=decimal-classification', ready: true, availability: 'ready' },
      { label: '[기본] 식의 계산 (지수법칙·단항식·다항식)', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=polynomial-operations-2', ready: true, availability: 'ready' },
      { label: '중2 유리수와 순환소수 세부 응용', href: '/middle-school/integers-rationals?unit=applied-rat-dec-all-mixed', ready: true, availability: 'ready' },
      { label: '중2 단항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-mono-all-mixed', ready: true, availability: 'ready' },
      { label: '중2 다항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-poly-calc-all-mixed', ready: true, availability: 'ready' },
      { label: '[기본] 제곱근과 실수', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=radicals-real-numbers&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 근호를 포함한 식의 계산', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9-radical-ops-mult-div&tier=basic', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: '중2 일차부등식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-ineq-app-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 연립일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-sys-linear-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 연립일차방정식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-sys-app-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 일차함수와 그 그래프 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-linear-func-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 일차함수와 일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-line-eqn-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2-1 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-grade8-semester-one-final-exam', ready: true, availability: 'ready' },
      { label: '[기본] 다항식의 곱셈과 인수분해', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=identities-factoring&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 이차방정식의 풀이와 활용', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=quadratic-equations&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 이차함수와 그 그래프', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=quadratic-functions&tier=basic', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: '[기본] 도형의 닮음과 피타고라스 정리', href: '/middle-school/basic-figures?profile=kr&unit=similarity-conditions', ready: true, availability: 'ready' },
      { label: '[기본] 삼각비의 값과 특수각의 삼각비', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-concept&tier=basic', ready: true, availability: 'ready' },
      { label: '[기본] 삼각비의 활용 (변의 길이와 넓이)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-trig-apps-length&tier=basic', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: '[기본] 경우의 수와 확률의 기본 성질', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=probability-2', ready: true, availability: 'ready' },
      ...
      { label: '중2 경우의 수 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-cases-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 확률과 그 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-g8-prob-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2-2 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=applied-grade8-semester-two-final-exam', ready: true, availability: 'ready' },
      { label: '[기본] 대푯값과 산포도 (평균·분산·표준편차)', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=data-variation', ready: true, availability: 'ready' },
      { label: '[기본] 상관관계와 산점도 분석', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=applied-g9s2-scatter-direction&tier=basic', ready: true, availability: 'ready' },
