...
const HONGKONG_STAGE_SEEDS = [
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Exponential & Logarithmic Functions', href: '/middle-school/pre-algebra?profile=kr-high-2-algebra&unit=logarithms', ready: true, availability: 'ready' },
      { label: 'Arithmetic Sequences & Series', href: '/middle-school/pre-algebra?profile=algebra-2&unit=sequences', ready: true, availability: 'ready' },
      { label: 'Geometric Sequences & Series', href: '/middle-school/pre-algebra?profile=algebra-2&unit=geometric-sequences', ready: true, availability: 'ready' },
      { label: 'Trigonometric Functions & Graphs', href: '/middle-school/pre-algebra?profile=kr-high-2-algebra&unit=precalc-trig-graphs', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Trigonometric Identities', href: '/middle-school/pre-algebra?profile=kr-high-2-algebra&unit=precalc-trig-identities', ready: true, availability: 'ready' },
...
const SINGAPORE_STAGE_SEEDS = [
  {
    ...
    topics: [
      ...
      { label: 'Congruence & Similarity', href: '/middle-school/basic-figures?unit=triangle-congruence-similarity', ready: true, availability: 'ready' },
      { label: "Pythagoras' Theorem", href: '/middle-school/basic-figures?unit=pythagorean-applications', ready: true, availability: 'ready' },
      { label: 'Mensuration: Solids', href: '/middle-school/basic-figures?profile=kr&unit=solid-elements', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Circle Properties: Chords & Tangents', href: '/middle-school/basic-figures?profile=kr&unit=circle-chord-properties', ready: true, availability: 'ready' },
      ...
      { label: 'Matrices', href: '/middle-school/pre-algebra?profile=kr-high-1&unit=matrices', ready: true, availability: 'ready' },
      { label: 'Statistics: Dispersion', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=data-variation', ready: true, availability: 'ready' },
    ],
  },
  {
    id: 'sg-jc-alevel',
