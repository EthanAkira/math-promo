...
export const KOREAN_GRADE_STAGES = [
  ...
  // 중학교 1학년
  {
    ...
    topics: [
      ...
      { label: '기본 도형 (점·선·면·각)', href: '/middle-school/basic-figures?profile=kr', ready: true, availability: 'ready' },
  ...
  // 중학교 2학년
  {
    ...
    topics: [
      ...
      { label: '유리수와 순환소수', href: '/middle-school/integers-rationals', ready: true, availability: 'ready' },
      { label: '식의 계산 (단항식·다항식)', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=polynomial-operations-2', ready: true, availability: 'ready' },
      ...
      { label: '도형의 성질 (삼각형·사각형)', href: '/middle-school/basic-figures', ready: true, availability: 'partial' },
  ...
  // 중학교 3학년
  {
    ...
    topics: [
      ...
      { label: '삼각비', href: '#', ready: false, availability: 'planned' },
      { label: '원의 성질', href: '#', ready: false, availability: 'planned' },
  ...
  // 고등학교 1학년 (기존 분류: 수학(상)·수학(하) / 2022 개정: 공통수학1·공통수학2)
  {
    ...
    topics: [
      ...
      },
      {
        ...
        href: '/middle-school/basic-figures?profile=csat',
        ready: true,
        availability: 'ready',
      },
    ],
...
export const INTERNATIONAL_COURSE_STAGES = [
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Linear & Quadratic Functions', href: '/middle-school/pre-algebra?profile=algebra-1&unit=quadratic-functions', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    availability: 'ready',
    topics: [
      { label: 'Geometry Foundations (Points, Lines, Angles)', href: '/middle-school/basic-figures', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: 'Math II · Geometry & Quadratics', href: '#', ready: false, availability: 'planned' },
...
export const DOMAIN_STAGES = [
  ...
  },
  {
    ...
    availability: 'ready',
    topics: [
      { label: '기본 도형 (점·선·면·각)', href: '/middle-school/basic-figures', ready: true, availability: 'ready' },
      { label: '수능/고등 기하 기초', href: '/middle-school/basic-figures?profile=csat', ready: true, availability: 'ready' },
