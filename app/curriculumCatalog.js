...
const KOREAN_GRADE_STAGE_SEEDS = [
  ...
  // 중학교 1학년
  {
    ...
    topics: [
      ...
      { label: '소수와 소인수분해', href: '/middle-school/prime-factorization', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=primes-factorization' } },
      ...
      { label: '좌표와 그래프', href: '/middle-school/coordinate-plane', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=coordinate-geometry' } },
      { label: '정비례와 반비례', href: '/middle-school/proportion', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=ratios-percent' } },
      { label: '기본 도형 (점·선·면·각)', href: '/middle-school/basic-figures?profile=kr&unit=visual-foundations', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=angles-plane-figures' } },
      ...
      { label: '원과 부채꼴', href: '/middle-school/basic-figures?profile=kr&unit=circle-sector-inverse-basic', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=circles' } },
  ...
  // 중학교 2학년
  {
    ...
    topics: [
      ...
      { label: '연립일차방정식', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=systems-linear', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=equations-inequalities' } },
      { label: '일차함수와 그래프', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=linear-functions-2', ready: true, availability: 'ready' },
      { label: '도형의 성질 (삼각형·사각형)', href: '/middle-school/basic-figures?profile=kr&unit=isosceles-triangle-properties', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=quadrilaterals-polygons' } },
      { label: '도형의 닮음과 피타고라스 정리', href: '/middle-school/basic-figures?profile=kr&unit=similarity-conditions', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=triangles' } },
      { label: '확률과 그 기본 성질', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=probability-2', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=probability' } },
    ],
  },
  ...
  // 고등학교 1학년 (기존 분류: 수학(상)·수학(하) / 2022 개정: 공통수학1·공통수학2)
  {
    ...
    topics: [
      ...
      },
      {
        ...
        ready: true,
        availability: 'partial',
        amc: { href: '/amc/units?unit=venn-sets' },
      ...
      { label: '공통수학2 · 도형의 대칭이동', href: '/middle-school/basic-figures?profile=kr&unit=transform-reflection', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=symmetry-transformations' } },
      ...
      { label: '공통수학2 · 삼단논법과 추론의 타당성', href: '/middle-school/basic-figures?profile=kr&unit=logic-detachment-syllogism', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=logical-reasoning' } },
  ...
  // 예전 2015 개정 이름(수학Ⅰ·수학Ⅱ)은 참고용 legacy 표기로만 남긴다.
  {
    ...
    topics: [
      ...
      { label: '등차수열의 뜻과 일반항', href: '/middle-school/pre-algebra?profile=kr-high-2-algebra&unit=sequences', ready: true, availability: 'ready', amc: { href: '/amc/units?unit=sequences-patterns' } },
