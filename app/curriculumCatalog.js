...
const KOREAN_GRADE_STAGE_SEEDS = [
  ...
  // 중학교 1학년
  {
    ...
    topics: [
      ...
      { label: '기본 도형 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-geo-basic-all-mixed', ready: true, availability: 'ready' },
      { label: '위치 관계 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-pos-all-mixed', ready: true, availability: 'ready' },
      { label: '작도와 합동 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-cong-all-mixed', ready: true, availability: 'ready' },
      ...
      { label: '다각형 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-poly-all-mixed', ready: true, availability: 'ready' },
      ...
      { label: '원과 부채꼴 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-circle-sector-all-mixed', ready: true, availability: 'ready' },
      ...
      { label: '다면체와 회전체 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-polyhedra-revolution-all-mixed', ready: true, availability: 'ready' },
      ...
      { label: '입체도형 겉넓이·부피 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-solids-surface-volume-all-mixed', ready: true, availability: 'ready' },
      ...
      { label: '자료의 정리와 해석 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-data-statistics-all-mixed', ready: true, availability: 'ready' },
  ...
  // 중학교 2학년
  {
    ...
    topics: [
      ...
      { label: '유리수와 순환소수 세부 응용', href: '/middle-school/integers-rationals?unit=rpm-rat-dec-all-mixed', ready: true, availability: 'ready' },
      ...
      { label: '단항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-mono-all-mixed', ready: true, availability: 'ready' },
      { label: '다항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-poly-calc-all-mixed', ready: true, availability: 'ready' },
      { label: '일차부등식', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=linear-inequalities-2', ready: true, availability: 'ready' },
      { label: '일차부등식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-linear-ineq-all-types-mixed', ready: true, availability: 'ready' },
      { label: '일차부등식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-ineq-app-all-types-mixed', ready: true, availability: 'ready' },
      ...
      { label: '연립일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-sys-linear-all-types-mixed', ready: true, availability: 'ready' },
      { label: '연립일차방정식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-sys-app-all-types-mixed', ready: true, availability: 'ready' },
      { label: '일차함수와 그래프', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=linear-functions-2', ready: true, availability: 'ready' },
      { label: '일차함수와 그 그래프 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-linear-func-all-types-mixed', ready: true, availability: 'ready' },
      { label: '일차함수와 일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-line-eqn-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2-1 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-grade8-semester-one-final-exam', ready: true, availability: 'ready' },
      ...
      { label: '중2 이등변삼각형 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-iso-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 삼각형의 외심과 내심 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-incenter-circumcenter-mixed', ready: true, availability: 'ready' },
      { label: '중2 평행사변형 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-parallelogram-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 여러 가지 사각형 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-special-quads-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 도형의 닮음 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-similarity-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 평행선과 선분의 길이의 비 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-parallel-segments-all-mixed', ready: true, availability: 'ready' },
      { label: '중2 삼각형의 무게중심 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-centroid-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 피타고라스 정리 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-pythagorean-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 경우의 수 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-cases-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 확률과 그 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-g8-prob-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2-2 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-grade8-semester-two-final-exam', ready: true, availability: 'ready' },
    ],
  },
...
const DOMAIN_STAGE_SEEDS = [
  {
    ...
    topics: [
      ...
      { label: '중2 유리수와 순환소수 세부 응용', href: '/middle-school/integers-rationals?unit=rpm-rat-dec-all-mixed', ready: true, availability: 'ready' },
      { label: '중2 단항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-mono-all-mixed', ready: true, availability: 'ready' },
      { label: '중2 다항식의 계산 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-poly-calc-all-mixed', ready: true, availability: 'ready' },
      { label: '제곱근과 실수', href: '/middle-school/pre-algebra?profile=kr-middle-3&unit=radicals-real-numbers', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: '중2 일차부등식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-linear-ineq-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 일차부등식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-ineq-app-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 연립일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-sys-linear-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 연립일차방정식의 활용 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-sys-app-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 일차함수와 그 그래프 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-linear-func-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2 일차함수와 일차방정식 세부 응용', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-line-eqn-all-types-mixed', ready: true, availability: 'ready' },
      { label: '중2-1 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/pre-algebra?profile=kr-middle-2&unit=rpm-grade8-semester-one-final-exam', ready: true, availability: 'ready' },
  ...
  },
  {
    ...
    topics: [
      ...
      { label: '중1 자료의 정리와 해석 세부 응용', href: '/middle-school/basic-figures?profile=kr&unit=rpm-data-statistics-all-mixed', ready: true, availability: 'ready' },
      { label: '중1-2 전 범위 최종 실전 총괄 모의고사', href: '/middle-school/basic-figures?profile=kr&unit=rpm-grade7-semester-two-final-exam', ready: true, availability: 'ready' },
