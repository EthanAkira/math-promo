...
const KOREAN_GRADE_STAGE_SEEDS = [
  ...
  // 중학교 1학년
  {
    ...
    topics: [
      ...
      { label: '소인수분해 응용 문제 (AMC)', href: '/amc/units?unit=primes-factorization', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '자릿수와 진법 응용 (AMC)', href: '/amc/units?unit=bases-digits', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '거듭제곱의 끝자리 규칙 응용 (AMC)', href: '/amc/units?unit=units-digit-cycles', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '나머지와 배수 판정 응용 (AMC)', href: '/amc/units?unit=remainders-divisibility', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '사칙연산과 계산 법칙 응용 (AMC)', href: '/amc/units?unit=arithmetic-operations', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '비와 백분율 응용 (AMC)', href: '/amc/units?unit=ratios-percent', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '백분율·할인과 이익 응용 (AMC)', href: '/amc/units?unit=percentages-money', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '각도와 평행선 응용 (AMC)', href: '/amc/units?unit=angles-plane-figures', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '원과 부채꼴 응용 문제 (AMC)', href: '/amc/units?unit=circles', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '좌표평면과 격자점 응용 (AMC)', href: '/amc/units?unit=coordinate-geometry', ready: true, availability: 'ready', meta: { source: 'AMC' } },
    ],
  },
  ...
  // 중학교 2학년
  {
    ...
    topics: [
      ...
      { label: '방정식과 부등식 응용 (AMC)', href: '/amc/units?unit=equations-inequalities', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '속력·거리·시간 응용 (AMC)', href: '/amc/units?unit=speed-distance-time', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '삼각형의 성질 응용 (AMC)', href: '/amc/units?unit=triangles', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '사각형과 다각형 응용 (AMC)', href: '/amc/units?unit=quadrilaterals-polygons', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '도형의 넓이와 둘레 응용 (AMC)', href: '/amc/units?unit=area-perimeter', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '입체도형 응용 문제 (AMC)', href: '/amc/units?unit=solids', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '경우의 수 응용 (AMC)', href: '/amc/units?unit=counting', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '확률 응용 문제 (AMC)', href: '/amc/units?unit=probability', ready: true, availability: 'ready', meta: { source: 'AMC' } },
    ],
  },
  ...
  // 중학교 3학년
  {
    ...
    topics: [
      ...
      { label: '집합과 벤다이어그램 응용 (AMC)', href: '/amc/units?unit=venn-sets', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '순열과 나열 응용 (AMC)', href: '/amc/units?unit=permutations-arrangements', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '조합과 대표 선출 응용 (AMC)', href: '/amc/units?unit=permutations-combinations', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '경로 찾기와 격자길 응용 (AMC)', href: '/amc/units?unit=paths-grids', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '논리적 추론 응용 (AMC)', href: '/amc/units?unit=logical-reasoning', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '실생활 문장제 응용 (AMC)', href: '/amc/units?unit=word-problems', ready: true, availability: 'ready', meta: { source: 'AMC' } },
    ],
  },
  ...
  // 고등학교 1학년 (기존 분류: 수학(상)·수학(하) / 2022 개정: 공통수학1·공통수학2)
  {
    ...
    topics: [
      ...
      { label: '대칭·회전과 공간지각 응용 (AMC)', href: '/amc/units?unit=symmetry-transformations', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '수열과 규칙성 응용 (AMC)', href: '/amc/units?unit=sequences-patterns', ready: true, availability: 'ready', meta: { source: 'AMC' } },
      { label: '암호산과 수학 퍼즐 응용 (AMC)', href: '/amc/units?unit=cryptarithms-puzzles', ready: true, availability: 'ready', meta: { source: 'AMC' } },
    ],
  },
  ...
  // 예전 2015 개정 이름(수학Ⅰ·수학Ⅱ)은 참고용 legacy 표기로만 남긴다.
  {
    ...
    topics: [
      ...
      { label: '등차수열의 뜻과 일반항', href: '/middle-school/pre-algebra?profile=kr-high-2-algebra&unit=sequences', ready: true, availability: 'ready' },
